    ...
    <nav className="w-full bg-transparent h-20 flex flex-col md:flex-row justify-between items-center px-5 z-50 fixed top-0">
      ...
      <div className="flex items-center gap-4">
        {!isAuthenticated ? (
          <>
            <Link to="/login">
              <button className="bg-transparent text-white font-bold py-1 px-4 rounded hover:text-blue-900  transition duration-300 ease-in-out shadow-lg transform hover:scale-105">
                Login
              </button>
            </Link>
          </>
